...
}`;function sa(e,a,t){const i=e.getActiveUniformBlockParameter(a,t,e.UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES),o=e.getActiveUniforms(a,i,e.UNIFORM_OFFSET),r=e.getActiveUniforms(a,i,e.UNIFORM_ARRAY_STRIDE),l={};for(let s=0;s<i.length;s++){const{name:n,type:f,size:u}=e.getActiveUniform(a,i[s]);l[n]={type:f,size:u,offset:o[s],stride:r[s]}}return l}function O(e,a,t,i,o,r,l){const s=Math.min(l.length/r,t);for(let n=0;n<s;n++)for(let f=0;f<r;f++)e[a](i+n*o+f*4,l[r*n+f],!0)}function la(e,a,t){const i=e.getUniformBlockIndex(a,t),o=e.getActiveUniformBlockParameter(a,i,e.UNIFORM_BLOCK_DATA_SIZE),r=sa(e,a,i),l=e.createBuffer();e.bindBuffer(e.UNIFORM_BUFFER,l),e.bufferData(e.UNIFORM_BUFFER,o,e.STATIC_DRAW);const s=new DataView(new ArrayBuffer(o));function n(p,L){if(!r[p])return;const{type:d,size:m,offset:x,stride:S}=r[p];switch(d){case e.FLOAT:O(s,"setFloat32",m,x,S,1,L);break;case e.FLOAT_VEC2:O(s,"setFloat32",m,x,S,2,L);break;case e.FLOAT_VEC3:O(s,"setFloat32",m,x,S,3,L);break;case e.FLOAT_VEC4:O(s,"setFloat32",m,x,S,4,L);break;case e.INT:O(s,"setInt32",m,x,S,1,L);break;case e.INT_VEC2:O(s,"setInt32",m,x,S,2,L);break;case e.INT_VEC3:O(s,"setInt32",m,x,S,3,L);break;case e.INT_VEC4:O(s,"setInt32",m,x,S,4,L);break;case e.BOOL:O(s,"setUint32",m,x,S,1,L);break;default:console.warn("UniformBuffer: Unsupported type")}}function f(p){e.bindBuffer(e.UNIFORM_BUFFER,l),e.bufferSubData(e.UNIFORM_BUFFER,0,s),e.bindBufferBase(e.UNIFORM_BUFFER,p,l)}function u(){e.deleteBuffer(l)}return{set:n,bind:f,dispose:u}}function fa(e,a){const t={};for(const i of a){const o=[];t[i]={indices:He(e,i,o),textures:o}}return t}function Ye(e,a){const t={textures:[],indices:{}};for(const i of a)t.indices[i]=He(e,i,t.textures);return t}function He(e,a,t){const i=[];for(const o of e)if(!(o[a]&&o[a].image))i.push(-1);else{let l=t.length;for(let s=0;s<t.length;s++)if(t[s]===o[a]){l=s;break}l===t.length&&t.push(o[a]),i.push(l)}return i}function ua(e){const a={width:0,height:0};for(const i of e)a.width=Math.max(a.width,i.width),a.height=Math.max(a.height,i.height);const t=[];for(const i of e)t.push(i.width/a.width),t.push(i.height/a.height);return{maxSize:a,relativeSizes:t}}function C(...e){let a=0;for(let i=0;i<e.length;i++){const o=e[i],r=o.data?o.data.length/o.channels:0;a=Math.max(a,r)}const t=[];for(let i=0;i<a;i++)for(let o=0;o<e.length;o++){const{data:r=[],channels:l}=e[o];for(let s=0;s<l;s++)t.push(r[i*l+s])}return t}function da(e,a,t){const i=la(e,a,"Materials");return i.set("Materials.colorAndMaterialType[0]",C({data:[].concat(...t.color.map(o=>o.toArray())),channels:3},{data:t.type,channels:1})),i.set("Materials.roughnessMetalnessNormalScale[0]",C({data:t.roughness,channels:1},{data:t.metalness,channels:1},{data:[].concat(...t.normalScale.map(o=>o.toArray())),channels:2})),i.set("Materials.alphaSpecularTintSheenSheenTint[0]",C({data:t.alpha,channels:1},{data:t.specularTint,channels:1},{data:t.sheen,channels:1},{data:t.sheenTint,channels:1})),i.set("Materials.clearcoaRoughnessSubfaceTransmission[0]",C({data:t.clearcoat,channels:1},{data:t.clearcoatRoughness,channels:1},{data:t.subsurface,channels:1},{data:t.transmission,channels:1})),i.set("Materials.iorAtDistanceAnisotropicWorkflow[0]",C({data:t.ior,channels:1},{data:t.atDistance,channels:1},{data:t.anisotropic,channels:1},{data:t.workflow,channels:1})),i.set("Materials.specularColorGlossiness[0]",C({data:[].concat(...t.specularColor.map(o=>o.toArray())),channels:3},{data:t.glossiness,channels:1})),i.set("Materials.extinction[0]",C({data:[].concat(...t.extinction.map(o=>o.toArray())),channels:3},{data:t.anisotropic,channels:1})),i.set("Materials.diffuseNormalRoughnessMetalnessMapIndex[0]",C({data:t.diffuseMapIndex,channels:1},{data:t.normalMapIndex,channels:1},{data:t.roughnessMapIndex,channels:1},{data:t.metalnessMapIndex,channels:1})),i.set("Materials.emissiveSpecularGlossinessMapIndex[0]",C({data:t.emissiveMapIndex,channels:1},{data:t.specularMapIndex,channels:1},{data:t.glossinessMapIndex,channels:1},{data:t.emissiveMapIndex,channels:1})),i.set("Materials.diffuseNormalMapSize[0]",C({data:t.diffuseMapSize,channels:2},{data:t.normalMapSize,channels:2})),i.set("Materials.pbrMapSize[0]",t.pbrMapSize),i.bind(0),i}function We(e,a){let t;switch(a){case bt:t=e.CLAMP_TO_EDGE;break;case Ut:t=e.REPEAT;break;case Rt:t=e.GL_MIRRORED_REPEAT;break}return t}function oe(e,a,t=!1,i=3){const o=a.map(p=>p.image),r=a.map(p=>p.flipY),l=a.map(p=>We(e,p.wrapS)),s=a.map(p=>We(e,p.wrapT)),{maxSize:n,relativeSizes:f}=ua(o);return{texture:D(e,{width:n.width,height:n.height,gammaCorrection:t,data:o,flipY:r,channels:i,minFilter:e.NEAREST,magFilter:e.NEAREST,wrapS:l,wrapT:s}),relativeSizes:f}}function ke(e,a){const{materials:t,uvTransformBufferDataLength:i}=a,o=fa(t,["map","normalMap","emissiveMap"]),r=Ye(t,["roughnessMap","metalnessMap"]),l=Ye(t,["specularMap","glossinessMap"]),s={},n={};if(n.color=t.map(d=>d.color),n.roughness=t.map(d=>d.roughness),n.metalness=t.map(d=>d.metalness),n.normalScale=t.map(d=>d.normalScale),n.specularTint=t.map(d=>d.specularTint),n.sheen=t.map(d=>d.sheen),n.sheenTint=t.map(d=>d.sheenTint),n.clearcoat=t.map(d=>d.clearcoat),n.clearcoatRoughness=t.map(d=>d.clearcoatRoughness),n.transmission=t.map(d=>d.transmission),n.subsurface=t.map(d=>d.subsurface),n.ior=t.map(d=>d.ior),n.atDistance=t.map(d=>d.atDistance),n.extinction=t.map(d=>d.extinction),n.alpha=t.map(d=>d.alpha),n.workflow=t.map(d=>d.workflow==="Metalness"?0:1),n.specularColor=t.map(d=>d.specularColor),n.glossiness=t.map(d=>d.glossiness),n.type=t.map(d=>Ot),o.map.textures.length>0){const{relativeSizes:d,texture:m}=oe(e,o.map.textures,!0,4);s.diffuseMap=m,n.diffuseMapSize=d,n.diffuseMapIndex=o.map.indices}if(o.normalMap.textures.length>0){const{relativeSizes:d,texture:m}=oe(e,o.normalMap.textures,!1);s.normalMap=m,n.normalMapSize=d,n.normalMapIndex=o.normalMap.indices}if(r.textures.length>0){const{relativeSizes:d,texture:m}=oe(e,r.textures,!1);s.pbrMap=m,n.pbrMapSize=d,n.roughnessMapIndex=r.indices.roughnessMap,n.metalnessMapIndex=r.indices.metalnessMap}if(l.textures.length>0){const{relativeSizes:d,texture:m}=oe(e,l.textures,!1,4);s.pbrSGMap=m,n.pbrMapSize=d,n.specularMapIndex=l.indices.specularMap,n.glossinessMapIndex=l.indices.glossinessMap}if(o.emissiveMap.textures.length>0){const{relativeSizes:d,texture:m}=oe(e,o.emissiveMap.textures,!0);s.emissiveMap=m,n.pbrMapSize||(n.pbrMapSize=d),n.emissiveMapIndex=o.emissiveMap.indices}const f={NUM_MATERIALS:t.length,NUM_DIFFUSE_MAPS:o.map.textures.length,NUM_NORMAL_MAPS:o.normalMap.textures.length,NUM_DIFFUSE_NORMAL_MAPS:Math.max(o.map.textures.length,o.normalMap.textures.length),NUM_PBR_MAPS:r.textures.length,NUM_PBR_SG_MAPS:l.textures.length,NUM_EMISSIVE_MAPS:o.emissiveMap.textures.length,UVTRANSFORM_COLUMNS:ae(i/3).columnsLog,SUPPORTED_MAPS:Me.length},u=$(e,{vertex:{source:"void main() {}"},fragment:{includes:[ra],source:"void main() {}"},defines:f}),p=da(e,u.program,n);function L(){u.dispose(),p.dispose()}return{defines:f,textures:s,dispose:L}}function ca(e,a=1){const t=e.length/4,i=new Float32Array(t*3),o=[];for(let r=0;r<255;r++)o[r]=a*Math.pow(2,r-128)/255;for(let r=0;r<t;r++){const l=e[4*r],s=e[4*r+1],n=e[4*r+2],f=e[4*r+3],u=o[f];i[3*r]=l*u,i[3*r+1]=s*u,i[3*r+2]=n*u}return i}function pa(e){const a=document.createElement("canvas"),t=a.getContext("2d");return a.width=e.width,a.height=e.height,t.drawImage(e,0,0),t.getImageData(0,0,a.width,a.height).data}function La(e){let a;if(a={width:e.data.image.width,height:e.data.image.height,data:e.data.image.data,dataFormat:"float"},e.data.type===Et?a.data?a.data=ca(a.data,e.intensity):(a.data=pa(e.data.image),a.dataFormat="byte"):e.data.type==zt?console.error("Please use 'new RGBELoader().setDataType(THREE.FloatType)' to load hdr env map. Half-Float type will loss of precision and have an impression of the effect."):e.data.type!==Xe&&console.error(`No support environmentLight's data type: ${e.data.type.toString()}`),e.data.type===Xe&&e.data.format===Xt){const t=e.data.image.data,i=t.length/4,o=new Float32Array(i*3);for(let r=0;r<i;r++)o[r*3+0]=t[r*4+0],o[r*3+1]=t[r*4+1],o[r*3+2]=t[r*4+2];a.data=o}return a}function ma(e){let a;return e&&e.data&&e.data.isTexture?a=La(e):console.warn(`No support environment type: ${e.data}`),a}function xa(e,a,t){const i=new Float32Array(t*e*a);return{set(o,r,l,s){i[t*(r*e+o)+l]=s},get(o,r,l){return i[t*(r*e+o)+l]},width:e,height:a,channels:t,array:i}}function _a(e){const a=e.data,t={width:e.width+2,height:e.height+1},i=xa(t.width,t.height,2);for(let r=0;r<e.height;r++){const l=Math.sin(Math.PI*(r+.5)/e.height);for(let n=0;n<e.width;n++){const f=3*(r*e.width+n);let u=a[f],p=a[f+1],L=a[f+2],d=.2126*u+.7152*p+.0722*L;d*=l,i.set(n+2,r,0,i.get(n+1,r,0)+d/e.width),i.set(n+1,r,1,d)}const s=i.get(t.width-1,r,0);for(let n=1;n<i.width;n++)i.set(n,r,0,i.get(n,r,0)/s),i.set(n,r,1,i.get(n,r,1)/s);i.set(0,r+1,0,i.get(0,r,0)+s/e.height),i.set(0,r,1,s)}const o=i.get(0,i.height-1,0);for(let r=0;r<i.height;r++)i.set(0,r,0,i.get(0,r,0)/o),i.set(0,r,1,i.get(0,r,1)/o);return t.data=i.array,t}var va={source:e=>`
...
#endif
}if(si.LGL_BT){path.li+=LGL_Ar(path.ray,depth,lightSampleRec,bsdfSampleRec)*path.beta;path.LGL_Bb=true;return;}if(dot(si.normal,si.LGL_BW)>0.0){path.LGL_Bd=vec3(0.0);}path.li+=path.beta*si.emissive;path.beta*=exp(-path.LGL_Bd*si.t);MaterialSamples LGL_AZomSamples=getRandomMaterialSamples();if(si.LGL_BS==DISNEY){path.li+=LGL_e(si,path,LGL_AZomSamples.s1,LGL_AZomSamples.s2)*path.beta;}bsdfSampleRec.f=LGL_W(si,-path.ray.d,si.LGL_BW,bsdfSampleRec.L,bsdfSampleRec.pdf,LGL_AZomSamples);if(dot(si.LGL_BW,bsdfSampleRec.L)<0.0){path.LGL_Bd=-log(si.extinction)/si.LGL_BP;}if(bsdfSampleRec.pdf>0.0){path.beta*=bsdfSampleRec.f/bsdfSampleRec.pdf;}else{path.LGL_Bb=true;return;}if(depth>=2){float q=1.0-LGL_Ae(path.beta);if(LGL_AZomSample()<q){path.LGL_Bb=true;return;}path.beta/=1.0-q;}LGL_Ag(path.ray,si.position+EPS*bsdfSampleRec.L,bsdfSampleRec.L);}vec4 LGL_Az(inout Ray ray){SurfaceInteraction si;Path path;BsdfSampleRec bsdfSampleRec;LightSampleRec lightSampleRec;path.ray=ray;path.li=vec3(0);path.alpha=1.0;path.LGL_Bb=false;path.LGL_Bc=1.0;path.LGL_Bd=vec3(0.0);path.beta=vec3(1.0);for(int i=0;i<bounces;i++){if(path.LGL_Bb){return vec4(path.li,path.alpha);}LGL_n(path.ray,si,lightSampleRec,i);LGL_o(path.ray,si,lightSampleRec,i);bounce(path,i,si,bsdfSampleRec,lightSampleRec);}return vec4(path.li,path.alpha);}void main(){LGL_Ab(frameCount);vec2 vCoordAntiAlias=vCoord+jitter;vec3 direction=normalize(vec3(vCoordAntiAlias-0.5,-1.0)*vec3(camera.aspect,1.0,camera.fov));vec3 origin=camera.transform[3].xyz;direction=mat3(camera.transform)*direction;Ray cam;LGL_Ag(cam,origin,direction);vec4 LGL_Aj=LGL_Az(cam);if(!(LGL_Aj.x<INF&&LGL_Aj.x>-EPS)){LGL_Aj=vec4(0,0,0,1);}out_light=LGL_Aj;}`};function Aa(e,a){const t=[],i=e**a;for(let n=0;n<i;n++)t[n]=n;let o=t.length;const r=[];function l(){o=0}function s(){o>=t.length&&(Qt(t),l());let n=t[o++];for(let f=0;f<a;f++)r[f]=n%e+Math.random(),n=Math.floor(n/e);return r}return{next:s,restart:l,strataCount:e}}function qe(e,a){const t=[];for(const l of a)t.push(Aa(e,l));const i=[];function o(){let l=0;for(const s of t){const n=s.next();for(const f of n)i[l++]=f}return i}function r(){for(const l of t)l.restart()}return{next:o,restart:r,strataCount:e}}let re=[],se=0,Le=[];function Ze(e,a){const t=[],i=[];let o=1;const r={x:1,y:2,z:3},l=(s,n=1)=>{if(o=Math.max(n,o),s.primitives)for(let f=0;f<s.primitives.length;f++){const u=s.primitives[f];if(u.indices!==void 0){const p=Le[u.meshID];t.push(u.indices[0]+p,u.indices[1]+p,u.indices[2]+p,s.primitives.length,u.faceNormal.x,u.faceNormal.y,u.faceNormal.z,u.meshID)}else t.push(re[u.meshID],u.materialID,u.meshID,0,u.visible,.1,.1,0);i.push(!1)}else{const f=s.bounds;t.push(f.min.x,f.min.y,f.min.z,r[s.splitAxis],f.max.x,f.max.y,f.max.z,null);const u=t.length-1;i.push(!0),l(s.child0,n+1),t[u]=t.length/4+a,l(s.child1,n+1)}};return l(e),{maxDepth:o,count:t.length/4,flatData:t,isBounds:i}}function ha(){re=[],se=0,Le=[]}function je(e,a){return Ze(e,se)}function Sa(e,a,t){const i=[];re=[],Le=[];let o=0,r=0,l=0,s=1;for(let n=0;n<e.length;n++){const f=e[n],u=a[n].geometry;Le.push(r);const p=Ze(f,o);s=Math.max(p.maxDepth,s),re.push(o),o+=p.count,i.push(p),r+=u.getAttribute("position").count,l+=p.flatData.length}return{totalBLASDataNum:l,totalBLASCount:o,flatBVHInfos:i,maxDepth:s}}function Ma(e,a){const t=e.totalBLASDataNum,i=e.flatBVHInfos,o=a,r=o.flatData.length,l=t+r,s=new ArrayBuffer(4*l),n=new Float32Array(s);for(let L=0;L<i.length;L++){const d=i[L],m=re[L]*4,{flatData:x,isBounds:S}=d;for(let I=0;I<S.length;I++){let _=8*I,h=_+m;S[I]?(n[h]=x[_],n[h+1]=x[_+1],n[h+2]=x[_+2],n[h+3]=x[_+3]):(n[h]=x[_],n[h+1]=x[_+1],n[h+2]=x[_+2],n[h+3]=-x[_+3]),n[h+4]=x[_+4],n[h+5]=x[_+5],n[h+6]=x[_+6],n[h+7]=x[_+7]}}const{flatData:f,isBounds:u}=o,p=se*4;for(let L=0;L<u.length;L++){let d=8*L,m=d+p;u[L],n[m]=f[d],n[m+1]=f[d+1],n[m+2]=f[d+2],n[m+3]=f[d+3],n[m+4]=f[d+4],n[m+5]=f[d+5],n[m+6]=f[d+6],n[m+7]=f[d+7]}return{bvhBufferDataNum:l,buffer:n}}function Fa(e,a,t,i){const o=Sa(e,t);se=o.totalBLASCount;const r=je(a),{bvhBufferDataNum:l,buffer:s}=Ma(o,r);return{maxDepth:o.maxDepth+r.maxDepth,count:l/4,buffer:s,tlasRootIndex:se}}let ee,me;function Ga(e){const a=e.getAttribute("position");if(!a){console.warn("No position attribute");return}const t=new Uint32Array(a.count);for(let i=0;i<t.length;i++)t[i]=i;return e.setIndex(new he(t,1,!1)),e}function Ia(e){let a=0,t=0;for(let o=0;o<e.length;o++){const r=e[o];r.geometry.isBufferGeometry||(r.geometry=new wt().fromGeometry(r.geometry));const l=r.geometry;l.getIndex()||Ga(l),l.getAttribute("normal")?l.normalizeNormals():l.computeVertexNormals(),a+=l.getAttribute("position").count,t+=l.getIndex().count}const i=Yt(e);return{vertexTotalCount:a,indexCount:t,blasBVHs:i}}function Ke(e,a){return Ht(e,a)}function Je(e){const a=new Float32Array(e.length*16);for(let t=0;t<e.length;t++){const i=e[t];i.updateMatrixWorld(!0);const o=i.matrixWorld.elements,r=16;for(let l=0;l<r;l++)a[t*r+l]=o[l]}return a}function Ta(){ee=null,me=null,ha()}function ga(e,a){const t=Ke(e,a),i=je(t),o=Je(e),{flatData:r,isBounds:l}=i,{buffer:s}=ee,n=me*4;for(let f=0;f<l.length;f++){let u=8*f,p=u+n;l[f],s[p]=r[u],s[p+1]=r[u+1],s[p+2]=r[u+2],s[p+3]=r[u+3],s[p+4]=r[u+4],s[p+5]=r[u+5],s[p+6]=r[u+6],s[p+7]=r[u+7]}return{bvhBufferInfo:ee,transformBufferData:o}}function Pa(e,a){var u;let t=e;const{vertexTotalCount:i,blasBVHs:o}=Ia(e),r=Ke(t,a);ee=Fa(o,r,e),me=ee.tlasRootIndex;const l=new Float32Array(i*4),s=new Float32Array(i*4);let n=0;for(let p=0;p<e.length;p++){const d=e[p].geometry,m=d.getAttribute("position").array,x=d.getAttribute("normal").array,S=(u=d.getAttribute("uv"))==null?void 0:u.array,I=d.getAttribute("position").count;for(let _=0;_<I;_++)l[n+_*4+0]=m[_*3+0],l[n+_*4+1]=m[_*3+1],l[n+_*4+2]=m[_*3+2],l[n+_*4+3]=S?S[_*2+0]:0,s[n+_*4+0]=x[_*3+0],s[n+_*4+1]=x[_*3+1],s[n+_*4+2]=x[_*3+2],s[n+_*4+3]=S?S[_*2+1]:0;n+=I*4}const f=Je(e);return{vertexTotalCount:i,bvhBufferInfo:ee,positionBufferData:l,normalBufferData:s,transformBufferData:f,tlasRootIndex:me}}function Na(e,a){return new Promise(t=>{const i=Pa(e,a);t(i)})}async function ya({decomposedScene:e,fullscreenQuad:a,gl:t,materialBuffer:i,uvTransformBuffer:o,optionalExtensions:r,useWorker:l,loadingCallback:s}){s&&s.onProgress&&typeof s.onProgress=="function"&&s.onProgress("Building BVH...");const{OES_texture_float_linear:n}=r,{camera:f,meshLightsNum:u,isTextureEnv:p,meshes:L,materialIndexMap:d}=e,{uvTransformBufferTex:m,uvTransformBufferDataCount:x,wrappingRootIndex:S}=o,{vertexTotalCount:I,bvhBufferInfo:_,positionBufferData:h,normalBufferData:T,transformBufferData:v,tlasRootIndex:G}=await Na(L,d),P=_,F=$(t,{defines:Ee({OES_texture_float_linear:n,BVH_COLUMNS:ae(P.count).columnsLog,VERTEX_COLUMNS:ae(I).columnsLog,TRANSFORM_COLUMNS:ae(v.length/4).columnsLog,UVTRANSFORM_COLUMNS:ae(x).columnsLog,SUPPORTED_MAPS:Me.length,MAX_DEPTH:P.maxDepth,NUM_LIGHTS:u,CONST_COLOR_ENV:!p},i.defines),fragment:va,vertex:a.vertexShader});return F.setTexture("diffuseMap",i.textures.diffuseMap),F.setTexture("normalMap",i.textures.normalMap),F.setTexture("pbrMap",i.textures.pbrMap),F.setTexture("pbrSGMap",i.textures.pbrSGMap),i.textures.emissiveMap&&F.setTexture("emissiveMap",i.textures.emissiveMap),F.setTexture("positionBuffer",j(t,h,4)),F.setTexture("normalBuffer",j(t,T,4)),F.setTexture("bvhBuffer",j(t,P.buffer,4)),F.setUniform("tlasIndex",G),F.setTexture("transformBuffer",j(t,v,4)),F.setUniform("wrappingIndex",S),F.setTexture("uvTransformBuffer",m),F}async function Ba(e,{bounces:a,decomposedScene:t,fullscreenQuad:i,materialBuffer:o,uvTransformBuffer:r,optionalExtensions:l,envMapIntensity:s,enviromentVisible:n,useWorker:f,loadingCallback:u}){let p;const L=await ya({bounces:a,decomposedScene:t,fullscreenQuad:i,gl:e,materialBuffer:o,uvTransformBuffer:r,optionalExtensions:l,useWorker:f,loadingCallback:u}),d=[];S(a),I(t),_(t);function m(A,g){L.setTexture("diffuseMap",A.textures.diffuseMap),L.setTexture("normalMap",A.textures.normalMap),L.setTexture("pbrMap",A.textures.pbrMap),L.setTexture("pbrSGMap",A.textures.pbrSGMap),A.textures.emissiveMap&&L.setTexture("emissiveMap",A.textures.emissiveMap);const{uvTransformBufferTex:b,wrappingRootIndex:R}=g;L.setUniform("wrappingIndex",R),L.setTexture("uvTransformBuffer",b)}function x(A){const{meshes:g,materialIndexMap:b}=A,{bvhBufferInfo:R,transformBufferData:B}=ga(g,b),E=R.buffer;L.setTexture("transformBuffer",j(e,B,4)),L.setTexture("bvhBuffer",j(e,E,4))}function S(A){d.length=0,A=ie(A,2,8);for(let g=1;g<=A;g++)d.push(2,2,2,2),g>=2&&d.push(1);L.setUniform("bounces",A),p&&(p.strataCount=-1)}function I(A){const{OES_texture_float_linear:g}=l,{environment:b,isTextureEnv:R}=A;if(R){const B=ma(b);if(B){const E=D(e,{data:B.data,storage:B.dataFormat,minFilter:g?e.LINEAR:e.NEAREST,magFilter:g?e.LINEAR:e.NEAREST,width:B.width,height:B.height});L.setTexture("envMap",E);const V=_a(B);L.setTexture("envMapDistribution",D(e,{data:V.data,storage:"float",width:V.width,height:V.height})),L.setUniform("envMapIntensity",s)}}else{const B=b.data;B&&B.isColor?L.setUniform("backgroundColor",[B.r,B.g,B.b]):L.setUniform("backgroundColor",[0,0,0])}T(n)}function _(A){const{meshLights:g}=A;g&&(L.setUniform("lights.position[0]",g.position),L.setUniform("lights.emission[0]",g.emission),L.setUniform("lights.p1[0]",g.p1),L.setUniform("lights.p2[0]",g.p2),L.setUniform("lights.params[0]",g.params))}function h(A){L.setUniform("envMapIntensity",A)}function T(A){L.setUniform("enviromentVisible",Number(A))}function v(A){L.setTexture("noiseTex",D(e,{data:A,wrapS:e.REPEAT,wrapT:e.REPEAT,storage:"halfFloat"}))}function G(A){L.setUniform("frameCount",A)}function P(){L.setUniform("stratifiedSamples[0]",p.next())}function F(A,g){L.setUniform("jitter",A,g)}function H(A){A>1&&A!==p.strataCount?p=qe(A,d):p.restart(),L.setUniform("strataSize",1/A),P()}function U(A,g){L.setUniform("pixelSize",1/A,1/g)}function le(A){L.setUniform("camera.transform",A.matrixWorld.elements),L.setUniform("camera.aspect",A.aspect),L.setUniform("camera.fov",.5/Math.tan(.5*Math.PI*A.fov/180)),A.isLensCamera&&(L.setUniform("camera.aperture",A.aperture),L.setUniform("camera.focus",A.focus))}function fe({position:A}){L.setTexture("gPosition",A)}function te(){L.bindTextures()}function N(){L.useProgram(!1),i.draw()}p=qe(1,d);function K(){Ta(),L.dispose()}return{bindTextures:te,draw:N,outputLocs:L.outputLocs,textures:L.textures,setSize:U,setCamera:le,setGBuffers:fe,setNoise:v,setJitter:F,setFrameCount:G,setStrataCount:H,nextSeed:P,setEnvMapIntensity:h,setEnviromentVisible:T,updateBounces:S,updateEnvLight:I,updateMeshLight:_,updateMeshTransform:x,updateMeshMaterial:m,dispose:K}}var Ra={source:"in vec3 aPosition;in vec3 aNormal;in vec2 aUv;uniform mat4 projView;uniform mat4 modelMat;uniform mat3 normalMat;out vec3 vPosition;out vec3 vNormal;out vec2 vUv;void main(){vec4 mPosition=modelMat*vec4(aPosition,1.);vPosition=mPosition.xyz;vNormal=normalize(normalMat*aNormal);vUv=aUv;gl_Position=projView*mPosition;}"},Ua={source:`
#define PI 3.14159265359
#define TWOPI 6.28318530718
#define INVPI 0.31830988618
#define INVPI2 0.10132118364
...
#endif
out_position=vec4(vPosition,float(meshIndex)+EPS);out_normal=vec4(normal,LGL_BS);out_color=color;}`};function Ge(e,a,t){if(a===void 0)return;const{itemSize:i,array:o}=t;if(e.enableVertexAttribArray(a),e.bindBuffer(e.ARRAY_BUFFER,e.createBuffer()),e.bufferData(e.ARRAY_BUFFER,o,e.STATIC_DRAW),o instanceof Float32Array)e.vertexAttribPointer(a,i,e.FLOAT,!1,0,0);else if(o instanceof Int32Array)e.vertexAttribIPointer(a,i,e.INT,0,0);else throw"Unsupported buffer type"}function ba(e,a,t){const i=t.getAttribute("position").count,o=new he(new Float32Array(3*i),3,!1),r=new he(new Float32Array(2*i),2,!1);Ge(e,a.attribLocs.aPosition,t.getAttribute("position")),Ge(e,a.attribLocs.aNormal,t.getAttribute("normal")||o),Ge(e,a.attribLocs.aUv,t.getAttribute("uv")||r),e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,e.createBuffer()),e.bufferData(e.ELEMENT_ARRAY_BUFFER,new Uint32Array(t.getIndex().array),e.STATIC_DRAW)}function Ea(e,{materialBuffer:a,uvTransformBuffer:t,decomposedScene:i}){const{meshes:o,materialIndexMap:r}=i,{uvTransformBufferTex:l,wrappingRootIndex:s}=t,n=$(e,{defines:a.defines,vertex:Ra,fragment:Ua});n.setTexture("diffuseMap",a.textures.diffuseMap),n.setTexture("normalMap",a.textures.normalMap),n.setUniform("wrappingIndex",s),n.setTexture("uvTransformBuffer",l);const f=[];for(let v=0;v<o.length;v++){const P=o[v].geometry,F=e.createVertexArray();e.bindVertexArray(F),ba(e,n,P),e.bindVertexArray(null),f.push(F)}let u=0,p=0;function L(v,G){u=v,p=G}let d;function m(v){d=v}let x=new we,S=new ze;function I(){x.copy(d.projectionMatrix),x.elements[8]+=2*u,x.elements[9]+=2*p,x.multiply(d.matrixWorldInverse),n.setUniform("projView",x.elements)}function _(){I(),e.enable(e.DEPTH_TEST),e.disable(e.CULL_FACE);for(let v=0;v<o.length;v++){const G=o[v];if(!G.visible)continue;const F=G.geometry.getIndex().count;n.setUniform("modelMat",G.matrixWorld.elements),S.getNormalMatrix(G.matrixWorld),n.setUniform("normalMat",S.elements),n.setUniform("meshIndex",v);const H=r.get(G.material);n.setUniform("materialIndex",H);const U=f[v];e.bindVertexArray(U),n.useProgram(),e.drawElements(e.TRIANGLES,F,e.UNSIGNED_INT,0)}e.enable(e.CULL_FACE),e.disable(e.DEPTH_TEST)}function h(v,G){n.setTexture("diffuseMap",v.textures.diffuseMap),n.setTexture("normalMap",v.textures.normalMap);const{uvTransformBufferTex:P,wrappingRootIndex:F}=G;n.setUniform("wrappingIndex",F),n.setTexture("uvTransformBuffer",P)}function T(){n.dispose()}return{draw:_,outputLocs:n.outputLocs,setCamera:m,setJitter:L,updateMeshMaterial:h,dispose:T}}var za={source:`layout(location=0)out vec4 out_color;uniform sampler2D inputBuffer;uniform vec2 resolution;in vec2 vCoord;
#define FXAA_PC 1
